...
figure, [Mlfp,Nlfp]=plot_tuning_polar(peod(1),ffile(1),[19],...
    'zfunc',@mean,'clim',clim,'mfunc','offset','bgcol',bgcol,'image',IMGS.cdata,'t_col',t_col,'ind_lim',ind_lim);
...
figure, [Mu1,Nu1]=plot_tuning_polar(peod(1),ffile(1),[22 23],...
    'zfunc',@sum,'clim',clim,'mfunc','offset','bgcol',bgcol,'image',IMGS.cdata,'t_col',t_col,'ind_lim',ind_lim);
set(gca,'Color',[1 1 1],'XColor',[1 1 1],'YColor',[1 1 1]);
set(gcf,'Color',[1 1 1]);
% colormap(modified_jet);
colorbar('off');
